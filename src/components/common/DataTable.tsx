...
export type FacetedConfig = {title: string; column: string; options: TOption[]};
...
export function DataTable<TData, TValue>({
  ...
  const rowModel = displaySelectedOnly ? table.getFilteredSelectedRowModel(): table.getRowModel()  
